...
const InfoUser= (paidAmount, loggedInfo)=>{
    ...
    if(isLoggedIn){
        ...
        console.log(`He has only paid the amount i.e ${paidAmount} but he is not logged in `)
    }
}
InfoUser(12000, true)
...
const oldArr= ['Hello ','Welcome', 'To ', 'My ', 'Youtube', 'Channel', true, 10000]
...
// Eg:2
const a=1,b=2,c=4,d=6,e=10,f=90, g=990,h=9,i=9,j=0;
const datas= {
    a,b,c,d,e,f,g,h,i,j
}
console.log(datas)
